...
public class AgendaContactos {
	...
	public AgendaContactos(int tam) {
		this.tam = tam;
	...
	public String verDirectorio() {
		...
		for (int i = 0; i < cantidad_ingresados; i++) {
			resp = resp.concat("Contacto No. "+(i+1)+" "+directorio[i]+"\n");
		}
		return resp;
	}
	
	public void borrarContacto(int pos) {
		directorio[pos] = new Persona();
	}
	
	public void correrPosiciones(int pos) {
		for (int i = pos; i < cantidad_ingresados; i++) {
